...
namespace QRTracking
{
    public class QRCodesVisualizer : MonoBehaviour
    {
        ...
        private GameObject observationParent = null;
        ...
        void Start()
        {
            ...
            observationParent = spatialObserver.ObservationParent;
            ...
            lock (pendingActions)
            {
                while (pendingActions.Count > 0)
                {
                    ...
                    if (action.type == ActionData.Type.Added)
                    {
                        ...
                        qrCodeObject.transform.parent = observationParent.transform;
                        qrCodeObject.name = $"Micro QR-TAG QR{action.qrCode.Data} [723995]";
